...
wget http://www.openssl.org/source/openssl-1.1.1.tar.gz -O openssl-1.1.1.tar.gz && tar -zxvf openssl-1.1.1.tar.gz && cd openssl-1.1.1 && ./config -prefix=$path shared zlib && make && make install && cd .. && rm -rf openssl-1.1.1*
